...
function venus() {
    ...
    var material = new THREE.MeshLambertMaterial({color:0xffba33});
...
function earth() {
    ...
    var material = new THREE.MeshLambertMaterial({color:0x00b38e});
...
function mars() {
    ...
    var mat = new THREE.MeshLambertMaterial({color:0xb34700});
...
function jupiter() {
    ...
    var mat = new THREE.MeshLambertMaterial({color:0xffcb80});
